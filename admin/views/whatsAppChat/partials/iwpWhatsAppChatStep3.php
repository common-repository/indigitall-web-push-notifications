<?php
	...
	$buttonIconWhatsApp 	= IWP_ADMIN_URL . 'images/webChat-icon.svg';
...
//	$step3Title 				= __('Chat Settings', 'iwp-text-domain');
	...
	$chatTypeDisableLabel 		= __('Disable chat (open Web Chat directly)', 'iwp-text-domain');
	...
	$chatTypeQrTip2 			= __('On computers, Web Chat will open directly.', 'iwp-text-domain');
	...
	$chatQrTextPlaceholder	 	= __('Scan this code to contact us through Web Chat', 'iwp-text-domain');
